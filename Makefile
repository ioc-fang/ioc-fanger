...
coverage: ## check code coverage quickly with the default Python
	coverage run --source ioc_fanger -m pytest
...
docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/ioc_fanger.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ ioc_fanger
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
upstream: ## set the upstream for the repository
	git remote set-upstream https://github.com/ioc-fang/ioc_fanger.git
